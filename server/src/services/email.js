...
const FROM_EMAIL = process.env.EMAIL_FROM || 'Cookmarker <noreply@cookmarker.de>';
...
/**
 * Send verification email with link. Uses Resend template; variable VERIFIY_EMAIL_TOKEN = full URL.
